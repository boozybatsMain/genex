...
0c. use `linear` cli to fetch the selected item into thoughts with the ticket number - ./thoughts/shared/tickets/NAG-xxxx.md
...
2g. document findings in a new thoughts document: `thoughts/shared/research/YYYY-MM-DD-NAG-XXXX-description.md`
...
```
✅ Completed research for NAG-XXXX: [ticket title]

Research topic: [research topic description]

The research has been:

Created at thoughts/shared/research/YYYY-MM-DD-NAG-XXXX-description.md
...
View the ticket: https://linear.app/not-ai-game/issue/NAG-XXXX/[ticket-slug]
```
