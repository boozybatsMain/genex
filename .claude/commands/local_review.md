...
2. **Extract ticket information**:
   - Look for ticket numbers in the branch name (e.g., `eng-1696`, `NAG-1696`)
...
3. **Set up the remote and worktree**:
   ...
   - If not, add it: `git remote add USERNAME git@github.com:USERNAME/not-ai-game-v2`
   - Fetch from the remote: `git fetch USERNAME`
   - Create worktree: `git worktree add -b BRANCHNAME ../not-ai-game-v2-SHORT_NAME USERNAME/BRANCHNAME`
...
- Create worktree at `../not-ai-game-v2-eng-1696`
