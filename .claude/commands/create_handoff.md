...
Use the following information to understand how to create your document:
    - create your file under `thoughts/shared/handoffs/NAG-XXXX/YYYY-MM-DD_HH-MM-SS_NAG-ZZZZ_description.md`, where:
        - YYYY-MM-DD is today's date
        - HH-MM-SS is the hours, minutes and seconds based on the current time, in 24-hour format (i.e. use `13:00` for `1:00 pm`)
        - NAG-XXXX is the ticket number (replace with `general` if no ticket)
        - NAG-ZZZZ is the ticket number (omit if no ticket)
        - description is a brief kebab-case description
    - Run the `scripts/spec_metadata.sh` script to generate all relevant metadata
    - Examples:
        - With ticket: `2025-01-08_13-55-22_NAG-2166_create-context-compaction.md`
...
# Handoff: NAG-XXXX {very concise description}
...
```bash
/resume_handoff thoughts/shared/handoffs/NAG-2166/2025-01-08_13-44-55_NAG-2166_create-context-compaction.md
```
</example_response>
